...
public class UpdateProfile extends AppCompatActivity {
    ...
    public void onSaveClick(View view) {
        if (checkEnableRegisterButton()){
            findedUser.setDisplayName(updateDisplayName.getText().toString());
            findedUser.setLocation(updateLocation.getText().toString());
            findedUser.setEmail(updateEmail.getText().toString());
            findedUser.setAboutMe(updateAboutme.getText().toString());
            findedUser.setProfileTagline(updateProfileTagline.getText().toString());
            findedUser.setLinkedinLink(updateLinkedin.getText().toString());
            findedUser.setGithubLink(updateGithub.getText().toString());
            findedUser.setMyTechStack(updateMyTechStack.getText().toString());
            saveUserInfo(findedUser);
        }else {
