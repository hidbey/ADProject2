...
public class BlogUser {
    ...
    private List<BlogUser> followings;
    ...
    public void setFollowings(List<BlogUser> followings) {
        this.followings = followings;
    }
    ...
    public String toString() {
        return "BlogUser [userId=" + userId + ", displayName=" + displayName + ", email=" + email + ", password="
                ...
                + ", followings=" + followings + ", followers=" + followers + ", blogHistories=" + blogHistories
